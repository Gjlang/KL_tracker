...
<body class="min-h-screen flex items-center justify-center p-4">
  ...
  <main class="auth-card">
    ...
    <div class="logo-badge">
      <img src="{{ asset('bluedale.png') }}" alt="Brand">
    </div>
    ...
    <div id="loginSection">
      ...
      <form method="POST" action="{{ route('login.store') }}" id="login-form" novalidate x-data="{ loading: false }" @submit="loading = true">
        @csrf
        ...
        <div class="form-group">
          ...
          @error('login')
            <p id="login-error" class="field-error">{{ $message }}</p>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <div class="form-input-container password-container" x-data="{ show: false }">
            ...
            <input
              ...
              class="form-input password-input {{ $errors->has('password') ? 'is-invalid' : '' }}"
        ...
        <div class="options-row">
          <label class="checkbox-container">
            <input type="checkbox" name="remember" value="1" class="checkbox-input" {{ old('remember') ? 'checked' : '' }}>
    ...
    <div id="registerSection" style="display: none;">
      ...
      <form method="POST" action="{{ route('register.store') }}" id="register-form" novalidate x-data="{ loading: false }" @submit="loading = true">
        @csrf

        ...
        <table id="billboard_availability_table" class="min-w-full border-collapse border border-neutral-300">
            <thead class="bg-neutral-50 sticky top-0 z-10">
                <tr>
                    ...
                    <th class="px-4 py-4 table-header min-w-[100px] w-[100px] border-r border-neutral-300">Start Date</th>
                    <th class="px-4 py-4 table-header min-w-[100px] w-[100px] border-r border-neutral-300">End Date</th>
                    <th class="px-4 py-4 table-header min-w-[100px] w-[100px] border-r border-neutral-300">Duration (Month)</th>
                    ...
                    <th class="px-4 py-4 table-header min-w-[150px] dt-exclude-export dt-no-sort border-r border-neutral-300">Detail</th>
...
<div class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden" id="remarksModal">
    <div class="modal__content bg-white rounded-xl shadow-xl w-full max-w-2xl mx-4"> <!-- Added rounded-xl -->
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-dark-5"> <!-- Added dark:border-dark-5 -->
            ...
            <button type="button" id="closeRemarksModal" class="text-gray-400 hover:text-gray-500 dark:text-gray-300 dark:hover:text-gray-200"> <!-- Added dark mode colors -->
        ...
        <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
            <div class="col-span-12 sm:col-span-12">
                <label class="block text-sm font-medium text-[#1C1E26] mb-2">Full Remarks</label> <!-- Added label styling -->
                <textarea class="input w-full px-4 py-3 border border-neutral-200 rounded-xl focus:ring-2 focus:ring-[#4bbbed] focus:border-[#4bbbed] transition-colors duration-200" id="remarksContent" rows="8" readonly></textarea> <!-- Updated styling to match other inputs -->
            </div>
        </div>
    </div>
</div>
    ...
    <div x-show="showEditStatusModal"
        ...
        <div class="modal__content bg-white rounded-xl shadow-xl w-full max-w-2xl mx-4"> <!-- Added rounded-xl -->
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-dark-5"> <!-- Added dark:border-dark-5 -->
                ...
                <button @click="showEditStatusModal = false; document.body.style.overflow = '';" type="button" class="text-gray-400 hover:text-gray-500 dark:text-gray-300 dark:hover:text-gray-200"> <!-- Added dark mode colors -->
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                    </svg>
                </button>
            ...
            <form id="editStatusForm">
                <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                    ...
                    <!-- Status Dropdown -->
                    <div class="col-span-12">
                        <label class="block text-sm font-medium text-[#1C1E26] mb-2">Status <span style="color: red;">*</span></label> <!-- Added label styling -->
                        <select id="editBookingStatus" class="input w-full px-4 py-3 border border-neutral-200 rounded-xl focus:ring-2 focus:ring-[#4bbbed] focus:border-[#4bbbed] transition-colors duration-200" required> <!-- Updated styling to match other inputs -->
                            <option disabled selected hidden value="">-- Select Status --</option>
                            <option value="pending_payment">Pending Payment</option>
                            <option value="pending_install">Pending Install</option>
                            <option value="ongoing">Ongoing</option>
                    ...
                    <!-- Remarks Textarea -->
                    <div class="col-span-12">
                        <label class="block text-sm font-medium text-[#1C1E26] mb-2">Remarks</label> <!-- Added label styling -->
                        <textarea id="editBookingRemarks" class="input w-full px-4 py-3 border border-neutral-200 rounded-xl focus:ring-2 focus:ring-[#4bbbed] focus:border-[#4bbbed] transition-colors duration-200" rows="3"></textarea> <!-- Updated styling to match other inputs -->
                    </div>
                </div>
                <!-- Buttons -->
                <div class="px-5 py-3 text-right border-t border-gray-200 dark:border-dark-5"> <!-- Added dark:border-dark-5 -->
                    <button type="button" @click="showEditStatusModal = false; document.body.style.overflow = '';" class="button w-20 bg-gray-300 text-gray-700 mr-2 hover:bg-gray-400 transition-colors duration-200">Cancel</button> <!-- Added hover and transition -->
                    <button type="button" id="editBookingButton" class="button w-20 bg-[#22255b] text-white hover:opacity-95 transition-colors duration-200">Update</button> <!-- Updated bg color to match theme -->
                </div>
            </form>
        </div>
    </div>
...
<div class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden" id="billboardBookingDeleteModal">
    <div class="modal__content bg-white rounded-xl shadow-xl w-full max-w-md mx-4">
        <div class="p-6">
            ...
            <div class="text-center">
                ...
                <p class="mt-2 text-sm text-gray-500">Confirm delete this Monthly Ongoing? This process cannot be undone.</p>
            </div>
            <!-- Buttons -->
            <div class="mt-6 flex justify-center space-x-3">
                <button type="button" id="cancelDeleteButton" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition">
                    Cancel
                </button>
                <button type="button" id="confirmDeleteButton" class="px-4 py-2 text-sm font-medium text-white bg-red-600 border border-transparent rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition">
                    Delete
                </button>
            </div>
        </div>
...
<script>
    ...
    async function exportCombinedExcel() {
        ...
        mergeInfo.forEach((rowMerges, dataRowIdx) => {
            ...
            rowMerges.forEach(merge => {
                ...
                const fontColor = (merge.color === 'bg-yellow-400') ? 'FF000000' : 'FFFFFFFF';
    ...
    function initBillboardAvailabilityDatatable() {
        ...
        const table = $('#billboard_availability_table').DataTable({
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        if (data == 'pending_payment'){
                            element = `<a class="p-2 w-24 rounded-full mr-1 mb-2 bg-red-600 text-white">Pending Payment</a>`;
                        } else if (data == 'pending_install'){
                            element = `<a class="p-2 w-24 rounded-full mr-1 mb-2 bg-blue-600 text-white">Pending Install</a>`;
                        } else if (data == 'ongoing') {
                            element = `<a class="p-2 w-24 rounded-full mr-1 mb-2 bg-green-600 text-white">Ongoing</a>`;
                        } else if (data == 'completed') {
                            element = `<a class="p-2 w-24 rounded-full mr-1 mb-2 bg-yellow-400 text-black">Completed</a>`;
            ...
            createdRow: function(row, data) {
                ...
                remarksCell.removeClass('text-center').addClass('text-left'); // Remove center, add left
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $(document).on("click", "#closeRemarksModal", function () { // Use the ID you assigned to the close button
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (typeof window.showSubmitToast === 'function') {
                        ...
                        console.warn("showSubmitToast function not found. Consider defining it for user feedback.");
                ...
                error: function(xhr, status, error) {
                    ...
                    if (xhr.responseJSON && xhr.responseJSON.message) {
                        ...
                        try {
                            ...
                            errorMessage = "Error: " + xhr.responseText.substring(0, 100); // Show first 100 chars
                        }
                    }
                    ...
                    if (typeof window.showSubmitToast === 'function') {
                        ...
                        console.warn("showSubmitToast function not found for error message.");
                        // Fallback: maybe show a simple alert if toast function is missing
                        // alert(errorMessage);
                    }
                }
            ...
            if (modalElement) {
                ...
                if (alpineComponent && typeof Alpine !== 'undefined' && Alpine.$data) {
                    ...
                    if (componentData && typeof componentData.showEditStatusModal !== 'undefined') {
                        ...
                        console.error("Alpine component does not have 'showEditStatusModal' property or Alpine is not initialized correctly on the component.");
                    ...
                    console.error("Could not find an Alpine.js component containing the modal or Alpine is not loaded.");
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (typeof window.showSubmitToast === 'function') {
                        ...
                        console.warn("showSubmitToast function not found for success message.");
                        // Fallback: maybe show a simple alert if toast function is missing

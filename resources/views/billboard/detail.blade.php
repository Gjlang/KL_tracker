    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="intro-y flex flex-col sm:flex-row items-center justify-between mb-8">
            ...
            <div class="mt-4 sm:mt-0">
                <a href="{{ route('billboard.download', $billboard_detail->id) }}"
                    class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-200 mr-2">
                    <i class="fas fa-download mr-2"></i> Download PDF [INTERNAL]
                </a>
                <a href="{{ route('billboard.download.client', $billboard_detail->id) }}"
                    class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition duration-200 mr-2">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li class="flex">
                            ...
                            <span class="text-gray-800">{{ $billboard_detail->district_name }},
                                {{ $billboard_detail->state_name }}</span>
                        </li>
                        <li class="flex">
                            <span class="w-48 font-medium text-gray-600">Council:</span>
                            <span class="text-gray-800">{{ $billboard_detail->council_abbrv }} -
                                {{ $billboard_detail->council_name }}</span>
                        </li>
                        <li class="flex">
                            <span class="w-48 font-medium text-gray-600">GPS Coordinate:</span>
                            <span class="text-gray-800">{{ $billboard_detail->gps_latitude }},
                                {{ $billboard_detail->gps_longitude }}</span>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li class="flex">
                            ...
                            <span class="text-gray-800">{{ $billboard_detail->prefix }} -
                                {{ $billboard_detail->type }}</span>
                        </li>
                        <li class="flex">
                        ...
                        <li class="flex">
                            ...
                            <span
                                class="text-gray-800">{{ $billboard_detail->site_type ? strtoupper($billboard_detail->site_type) : '-' }}</span>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="intro-y box bg-white rounded-xl shadow-lg p-6">
            ...
            @php
                $image1Exists = Storage::disk('public')->exists(
                    'billboards/' . $billboard_detail->site_number . '_1.png',
                );
                $image2Exists = Storage::disk('public')->exists(
                    'billboards/' . $billboard_detail->site_number . '_2.png',
                );
            @endphp
            ...
            <div class="intro-y mt-6">
                <div class="flex flex-col md:flex-row gap-6">
                    <!-- Image 1 Slot -->
                    <div id="image-slot-1"
                        class="flex-1 relative group h-86 overflow-hidden rounded-lg shadow bg-gray-100 border border-gray-200">
                        @if ($image1Exists)
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center hidden bg-black bg-opacity-50 modal"
        ...
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-4xl mx-4 overflow-hidden modal__content">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gray-50">
                ...
                <button type="button" onclick="closeAltEditorModal('#billboardEditModal')"
            ...
            <form id="billboardEditForm" action="{{ route('billboard.update') }}" method="POST">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6 max-h-[70vh] overflow-y-auto">
                    <div class="md:col-span-2">
                        ...
                        <label for="" class="block text-sm font-medium text-gray-700 mb-1">Outdoor Type <span
                        ...
                        <select
                            ...
                            id="editBillboardType" name="type" disabled>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Billboard Size <span
                                class="text-red-500">*</span></label>
                        <select
                            ...
                            id="editBillboardSize" name="size" required>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Lighting <span
                                class="text-red-500">*</span></label>
                        <select
                            class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                            id="editBillboardLighting" name="lighting" required>
                    ...
                    <div>
                        ...
                        <select
                            class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition bg-gray-100 cursor-not-allowed"
                            id="editBillboardState" name="state_id" disabled>
                    ...
                    <div>
                        ...
                        <select
                            class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                            id="editBillboardDistrict" name="district_id" required>
                            <option value="">-- Select District --</option>
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Council <span
                                class="text-red-500">*</span></label>
                        <select
                            class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition bg-gray-100 cursor-not-allowed"
                            id="editBillboardCouncil" name="council_id" disabled>
                    ...
                    <div>
                        ...
                        <input type="text"
                            class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                            id="editBillboardLocation" name="location_name" placeholder="Enter location name">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text"
                            class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                            id="editBillboardTrafficVolume" name="traffic_volume" value="" required>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Site Type</label>
                        <select
                            class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                            id="editBillboardSiteType" name="site_type">
                    ...
                    <div>
                        ...
                        <select
                            class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                            id="editBillboardStatus" name="status">
                            <option value="">-- Select option --</option>
                ...
                <div class="px-6 py-4 bg-gray-50 text-right border-t border-gray-200">
                    <button type="button" onclick="closeAltEditorModal('#billboardEditModal')"
                        class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition mr-2">
                        Cancel
                    </button>
                    <button type="submit"
                        class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition"
                        id="billboardEditButton">
                        Submit
                    </button>
                </div>
            </form>
                            ...
                            @if ($image1Exists)
                                {
                                    ...
                                    size: 12345,
                                    url: "{{ asset('storage/billboards/' . $billboard_detail->site_number . '_1.png') }}"
                                },
                            @endif
                            @if ($image2Exists)
                                {
                                    ...
                                    size: 12345,
                                    url: "{{ asset('storage/billboards/' . $billboard_detail->site_number . '_2.png') }}"
                                }
                            @endif
                        ];

...
<div class="intro-y box p-5 mt-5">
    ...
    <div class="flex flex-col sm:flex-row sm:items-end xl:items-start gap-4 mb-4">
        ...
        <div class="flex flex-col gap-2">
            ...
            <!-- Inventory Button -->
            <a href="{{ route('stockInventory.index')}}" class="flex items-center justify-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">

                ...
                <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                    ...
                    <form class="xl:flex sm:mr-auto">
                        ...
                        <div class="mt-2 xl:mt-0">
                            <button type="button" class="button w-full sm:w-16 bg-theme-32 text-white"
                                id="filterClientButton">Filter</button>
                        </div>
                    </form>
                    <!-- END: Filter -->
                    ...
                    <div class="text-center">
                        <a href="javascript:;" data-toggle="modal" data-target="#clientAddModal"
                            class="button w-50 mr-2 mb-2 flex items-center justify-center bg-theme-32 text-white">
            ...
            <form>
                ...
                <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 sm:col-span-12">
                        ...
                        <input type="text" title="Please enter client designation" placeholder="Enter a Designation"
                            class="input w-full border mt-2 flex-1" id="clientAddDesignation" required>
                    </div>
                    <div class="col-span-12 sm:col-span-12">
                        <label>Client Name</label>
                        <input type="text" placeholder="Enter a Client Name" class="input w-full border mt-2 flex-1"
                            id="clientAddName" required>
                    </div>
                    <div class="col-span-12 sm:col-span-12">
                        <label>Email</label>
                        <input type="text" placeholder="Enter a Client Email" class="input w-full border mt-2 flex-1"
                            id="clientAddEmail" required>
                    </div>
                    <div class="col-span-12 sm:col-span-12">
                        <label>Contact No.</label>
                        <input type="text" title="Please enter contact number in correct format"
                            placeholder="Enter a Contact Number" class="input w-full border mt-2 flex-1"
                            id="clientAddContact" required>
                    </div>
                ...
                <div class="px-5 py-3 text-right border-t border-gray-200 dark:border-dark-5">
                    <button type="submit" class="button w-50 bg-theme-1 text-white" id="clientAddButton">Save
                        Client</button>
                </div>
            </form>
        ...
        <div class="modal__content">
            ...
            <form>
                <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 sm:col-span-12">
                        <label>Client Name</label>
                        <input type="text" class="input w-full border mt-2 flex-1" placeholder="Client Name"
                            id="clientEditName" required>
                    </div>
                    <div class="col-span-12 sm:col-span-12">
                        <label>Contact No.</label>
                        <input type="text" class="input w-full border mt-2 flex-1" placeholder="Contact No"
                            id="clientEditContact" required>
                    </div>
                </div>

                <div class="px-5 py-3 text-right border-t border-gray-200 dark:border-dark-5">
                    <button type="submit" class="button w-20 bg-theme-1 text-white"
                        id="clientEditButton">Update</button>
                </div>
            </form>
        </div>
    </div>
        ...
        $(document).ready(function() {
            ...
            function clientEditModal() {
                ...
                $(document).on('click', "[id^='client_table'] tbody tr td:not(:last-child)", function() {
                    ...
                    document.getElementById("clientEditName").value = $(event.target).closest('tr').find(
                        'td:nth-child(' + '1' + ')').text();
                    document.getElementById("clientEditContact").value = $(event.target).closest('tr').find(
                        'td:nth-child(' + '2' + ')').text();

                    // Grab row client id
                    originalClientId = $(event.target).closest('tr').find('td:nth-child(7) a').attr('id')
                        .split('-')[1];

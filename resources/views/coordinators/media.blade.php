{{-- Main View File --}}
{{-- Pastikan layout/global sudah include Alpine.js --}}
...
<div class="min-h-screen bg-gray-50 py-6">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <select name="month" class="w-full border border-gray-300 rounded-md px-3 py-2 bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
            ...
            @foreach ($months as $m => $lab)
              <option value="{{ $m }}" {{ (int)$month === (int)$m ? 'selected' : '' }}>
                {{ str_pad($m, 2, '0', STR_PAD_LEFT) }} - {{ $lab }}
              </option>
            @endforeach
          </select>
        </div>
    ...
    @php
      $tabs = [
        'content'  => ['label' => 'Content', 'icon' => 'M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z'],
        'editing'  => ['label' => 'Editing', 'icon' => 'M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z'],

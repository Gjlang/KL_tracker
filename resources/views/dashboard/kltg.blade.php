                        ...
                        @if (isset($rows) && count($rows) > 0)
                            @foreach ($rows as $i => $r)
                                <tr class="table-row transition-all duration-150 hover:bg-neutral-50 hover:shadow-[inset_0_0_0_1px_rgba(0,0,0,0.03)]"
                                    ...
                                    data-year="{{ $year ?? date('Y') }}" data-month="{{ $r['month_name'] ?? '' }}"
                                    ...
                                    <td class="hairline px-4 py-3 align-top">
                                        <input class="form-input auto-save-input w-32"
                                            ...
                                            data-type="PUBLICATION" data-field="publication"
                                            oninput="debouncedSave(this)" placeholder="Type name…">
                                    </td>
...
$rowYear = (int) ($r['year'] ?? ($year ?? date('Y')));
                                                            ...
                                                            <div class="flex flex-col flex-1 p-3 space-y-2">
                                                                ...
                                                                <div class="flex items-center gap-2">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        placeholder="Type status…" data-input="text"
                                                                        data-master="{{ $r['id'] ?? '' }}"
                                                                    ...
                                                                    <input type="color"
                                                                        ...
                                                                        data-month="{{ $m }}"
                                                                        data-category="{{ $c['code'] }}"
                                                                        data-type="COLOR" data-color-target="prev"
                                                                ...
                                                                @php
                                                                    $inputIdStart =
                                                                        "date-start-y{$year}-m{$m}-{$c['code']}-{$r['id']}-" .
                                                                        uniqid();
                                                                @endphp

                                                                <div class="flex items-center gap-2">
                                                                    <input id="{{ $inputIdStart }}" type="date"
                                                                        ...
                                                                        data-month="{{ $m }}"
                                                                        data-category="{{ $c['code'] }}"
                                                                        data-type="START" onchange="saveCell(this)">
                                                                    <button type="button"
                            ...
                            <tr>
                                <td colspan="22" class="hairline px-6 py-16 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-neutral-600 mb-4">Try adjusting your filters or add new entries.
                                        </p>
                                        <a href="{{ route('coordinator.kltg.index') }}" class="btn-secondary">
                                            Open KLTG Coordinator
                                        </a>
    ...
    <script>
        ...
        function saveCell(el) {
            ...
            const monthRaw = el.dataset.month || el.closest('[data-month]')?.dataset.month || el.closest('td')?.dataset
                .month || el.closest('div[data-month]')?.dataset.month;

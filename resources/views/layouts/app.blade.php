...
<body class="min-h-screen bg-[#F7F7F9] text-[#1C1E26] antialiased">
    ...
    <div x-data="sidebar()" x-init="init()" class="min-h-screen flex">
        ...
        {{-- Mobile Overlay --}}
        <div x-show="isOpen" x-cloak @click="close()" class="fixed inset-0 z-40 bg-black bg-opacity-50 md:hidden"
    ...
    <script>
        ...
        window.showSubmitToast = function(message, color) {
            ...
            toast.className =
                'rounded-xl shadow-lg px-6 py-4 text-sm font-medium text-white transition-all duration-300 transform translate-x-0 opacity-100';

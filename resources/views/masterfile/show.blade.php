        ...
        <div class="w-screen min-h-screen bg-[#F7F7F9]" x-data="{
                ...
                <div class="w-full max-w-none px-6 lg:px-10 xl:px-14 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button type="button" @click="toggleEdit()" x-show="!edit"
                            ...
                            <button type="button" @click="saveForm()" x-show="edit"
                                x-style.display="edit ? 'flex' : 'none'" :disabled="saving"
                            ...
                            <button type="button" @click="cancelEdit()" x-show="edit"
            ...
            <div class="w-full max-w-none px-6 lg:px-10 xl:px-14 py-8">
                ...
                <form id="mfForm" method="POST" action="{{ route('masterfile.update', $file->id) }}">
                                    ...
                                    <div class="flex items-center gap-6">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <select name="status" :readonly="!edit"
                                                :class="edit ?
                                                    'h-11 rounded-xl border-neutral-300 focus:ring-2 focus:ring-[#4bbbed] focus:border-transparent' :
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <input name="product" value="{{ old('product', $file->product) ?: '' }}"
                                                ...
                                                :class="edit ?
                                                    'h-11 rounded-xl border-neutral-300 focus:ring-2 focus:ring-[#4bbbed] focus:border-transparent' :
                                                    'bg-transparent border-0 focus:ring-0 text-[#4bbbed]'"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                        ...
                        <div class="bg-white rounded-2xl border border-neutral-200/70 shadow-sm overflow-hidden">
                            <div
                                class="px-6 py-4 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 border-b border-neutral-200/70">
                                <h3 class="text-sm font-medium text-neutral-600 small-caps tracking-wide">Project
                                    Information</h3>
                            </div>
                            <div class="p-6 space-y-6">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-neutral-500 mb-2">Current
                                        Location</label>
                        ...
                        <div class="bg-white rounded-2xl border border-neutral-200/70 shadow-sm overflow-hidden">
                            <div
                                class="px-6 py-4 bg-gradient-to-r from-green-50/50 to-emerald-50/50 border-b border-neutral-200/70">
                                <h3 class="text-sm font-medium text-neutral-600 small-caps tracking-wide">Person In
                                    Charge & Job Details</h3>
                            </div>
                            <div class="p-6 space-y-6">
                                <div>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-neutral-500 mb-2">Contact
                                        Number</label>
                        ...
                        <div class="bg-white rounded-2xl border border-neutral-200/70 shadow-sm overflow-hidden">
                            <div
                                class="px-6 py-4 bg-gradient-to-r from-purple-50/50 to-pink-50/50 border-b border-neutral-200/70">
                                <h3 class="text-sm font-medium text-neutral-600 small-caps tracking-wide">Invoice
                                    Information</h3>
                            </div>
                            <div class="p-6 space-y-6">
                                <div>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-neutral-500 mb-2">Invoice
                                        Number</label>
                ...
                @if ($file->product_category === 'Outdoor' || $file->outdoorItems->count() > 0)
                    <div class="bg-white rounded-2xl border border-neutral-200/70 shadow-sm overflow-hidden">
                        <div
                            class="px-6 py-4 bg-gradient-to-r from-emerald-50/50 to-green-50/50 border-b border-neutral-200/70">
                            <div class="flex items-center justify-between">
                                <h3 class="text-sm font-medium text-neutral-600 small-caps tracking-wide">Outdoor
                                    Placements</h3>
                                <span class="text-sm text-neutral-500">
                                    Total locations: <span
                                        class="font-semibold tabular">{{ $file->outdoorItems->count() }}</span>
                        ...
                        <div class="overflow-x-auto">
                            @if ($file->outdoorItems->isEmpty())
                                <div class="p-8 text-center text-neutral-500">
                                    <svg class="w-12 h-12 mx-auto mb-4 text-neutral-300" fill="none"
...
$statusLabel = $bb?->status ?? ($item->status ?? '');
                                            ...
                                            <tr class="hover:bg-neutral-50/50 transition-colors duration-150">
                                                <td class="px-4 py-3 text-neutral-600 tabular">{{ $i + 1 }}
                                                </td>
                                                <td class="px-4 py-3 text-neutral-900">{{ $item->sub_product ?: '' }}
                                                </td>
                                                ...
                                                <td class="px-4 py-3 text-right tabular text-neutral-900">
                                                    {{ $item->qty ?? 1 }}</td>
                                                ...
                                                <td class="px-4 py-3 text-neutral-900" x-data="{
                                                    ...
                                                    <div class="inline-flex items-center gap-2">
                                                        ...
                                                        <span x-show="saving"
                                                            class="text-xs text-neutral-400">Saving…</span>
                                                    </div>
                                                </td>

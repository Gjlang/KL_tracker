      ...
      <div class="floating-card p-6">
        <form method="get" class="space-y-4">
          <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div>
              ...
              <select name="sub" class="elegant-input w-full">
                ...
                @foreach ($subOptions as $val => $label)
                  <option value="{{ $val }}" @selected(($sub ?? '') === $val)>{{ $label }}</option>
                @endforeach
              </select>
            </div>
            ...
            {{-- Clear --}}
            <div class="flex items-end">
              <a href="{{ route('outdoor.whiteboard.index') }}" class="secondary-btn w-full text-center">Clear</a>
            </div>
          </div>
          ...
          <div class="flex items-center gap-3 pt-2">
            <a
              href="{{ route('outdoor.whiteboard.export.ledger', ['q' => $search, 'sub' => $sub]) }}"

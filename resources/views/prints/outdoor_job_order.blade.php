...
<body>
  ...
  <table class="meta">
    <tr>
      <td class="left">&nbsp;</td>
      <td class="right">Updated: {{ now()->format('d/m/Y') }}</td>
    </tr>
  </table>
  ...
  <table style="margin-top:6px;">
    <tr>
      ...
      <td class="w30">{{ $file->company }}</td>
      <th class="w20">JOB ORDER NO.</th>
      <td class="w30">{{ $file->job_number }}</td>
    </tr>
    <tr>

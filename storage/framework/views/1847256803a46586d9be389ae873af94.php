...
<script>
    ...
    function initBillboardAvailabilityDatatable() {
        ...
        const table = $('#billboard_availability_table').DataTable({
            ...
            iDisplayLength: 25,
            ajax: {
                url: "<?php echo e(route('billboard.availability.index')); ?>",
                dataType: "json",
                type: "POST",
                method: "POST",
                data: function(d) {
    ...
    $(document).ready(function() {
        ...
        //             window.location.href = "<?php echo e(route('billboard.availability.index')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Gjlang\kl_guide_tracker\resources\views/billboard/availability/index.blade.php ENDPATH**/ ?>
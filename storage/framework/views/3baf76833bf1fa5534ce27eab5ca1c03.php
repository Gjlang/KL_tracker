...
<body>
  ...
  <div class="brand-row">
    ...
    <img class="logo" src="<?php echo e(public_path(path: 'logo.png')); ?>" alt="Logo">
  </div>
      ...
      <td class="left">
        ...
        <div class="cell">
          <table>
            <tr>
              ...
              <td style="width:32%;"><?php echo e($file->company); ?></td>
              <th style="width:20%;">JOB ORDER NO</th>
              <td style="width:30%;"><?php echo e($file->job_number); ?></td>
            </tr>
            <tr>
              <th>CONTACT PERSON</th>
              <td><?php echo e($file->client ?? ''); ?></td>
              <th>JOB ORDER DATE</th>
              <td><?php echo e($file->created_at ? \Carbon\Carbon::parse($file->created_at)->format('d/m/Y') : ''); ?></td>
            </tr>
            <tr>
              <th>CONTACT NUMBER</th>
              <td><?php echo e($file->contact_number ?? ''); ?></td>
              <th>SALES PERSON</th>
              <td><?php echo e($file->sales_person ?? ''); ?></td>
            </tr>
            <tr>
              <th>EMAIL</th>
              <td><?php echo e($file->email ?? ''); ?></td>
              <th>REFERENCE NUMBER</th>
              <td><?php echo e($file->reference_no ?? ''); ?></td>
            </tr>
          </table>
        </div>
        ...
        <div class="cell">
          <table>
            <tr>
              ...
              <td style="width:25%;">
                <span class="tick <?php echo e(str_contains(strtolower($file->product ?? ''), 'guide') ? 'is-ticked' : ''); ?>"></span>
              </td>
              <th style="width:25%;">REFERENCE</th>
              <td style="width:25%;"><?php echo e($file->reference_no2 ?? ''); ?></td>
            </tr>
            <tr>
              <th>Klang Valley 4 Locals</th>
              <td>
                <span class="tick <?php echo e(str_contains(strtolower($file->product ?? ''), 'locals') ? 'is-ticked' : ''); ?>"></span>
              </td>
              <th>ISSUE</th>
              <td></td>
            </tr>
            <tr>
              <th>Listing</th>
              <td><span class="tick <?php echo e(str_contains(strtolower($file->product ?? ''), 'listing') ? 'is-ticked' : ''); ?>"></span></td>
              <th>&nbsp;</th>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <th>e-Guide</th>
              <td><span class="tick <?php echo e(str_contains(strtolower($file->product ?? ''), 'e-guide') ? 'is-ticked' : ''); ?>"></span></td>
              <th>&nbsp;</th>
              <td>&nbsp;</td>
            </tr>
          </table>
        ...
        <div class="cell">
          <table>
            <tr>
              ...
              <td style="width:70%;"><?php echo nl2br(e($file->requirements ?? $file->remarks ?? '')); ?></td>
            </tr>
            <tr>
              <th>ARTWORK DEADLINE</th>
              <td><?php echo e($file->artwork_deadline ?? ''); ?></td>
            </tr>
          </table>
        </div>
        ...
        <div class="cell" style="padding:0;">
          <table>
            ...
            ?>
            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td><?php echo e($code); ?></td>
                <td><?php echo e($label); ?></td>
                <td><?php echo nl2br(e($file->notes ?? '')); ?></td>
              </tr>
        ...
        <div class="sig-wrap">
          ...
          <table class="no-border" style="width:100%; margin-top:4px;">
            ...
            <tr>
              <td class="no-border">Date: <?php echo e($date ?? ''); ?></td>
...
<?php /**PATH C:\Users\Gjlang\kl_guide_tracker\resources\views\prints\kltg_job_order.blade.php ENDPATH**/ ?>
...
<div class="w-screen min-h-screen bg-[#F7F7F9]">
  <div class="w-full max-w-none px-6 lg:px-10 xl:px-14 py-6 space-y-6">
    ...
    <div class="bg-white rounded-2xl border border-neutral-200/70 shadow-sm p-6">
      <form action="<?php echo e(route('information.booth.store')); ?>" method="POST" class="space-y-5">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Gjlang\kl_guide_tracker\resources\views\information_booth\_form.blade.php ENDPATH**/ ?>
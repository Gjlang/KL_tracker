...
<div class="bg-white rounded-2xl border border-neutral-200/70 shadow-sm p-6">
    <h2 class="text-xl font-serif font-medium ink mb-4"><?php echo e($title); ?></h2>
    <div <?php echo e($attributes->merge(['class' => ''])); ?>>
        <?php echo e($slot); ?>

    </div>
</div>
<?php /**PATH D:\Projects\Laravel\KL_tracker\resources\views\components\card.blade.php ENDPATH**/ ?>
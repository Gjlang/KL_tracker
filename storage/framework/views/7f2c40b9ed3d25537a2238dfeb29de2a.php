          ...
          <?php if(($rows ?? [])->count() > 0): ?>
            ...
            <div class="flex items-center justify-between px-4 py-2 hairline border-b">
              ...
              <div class="flex items-center gap-2">
                <button id="prevPage" type="button" class="px-3 py-1.5 text-xs rounded-full border border-neutral-300 text-neutral-700 hover:bg-neutral-50 disabled:opacity-40" disabled>Prev</button>
                <span id="pageInfo" class="text-xs text-neutral-600">1 / 1</span>
                <button id="nextPage" type="button" class="px-3 py-1.5 text-xs rounded-full border border-neutral-300 text-neutral-700 hover:bg-neutral-50 disabled:opacity-40">Next</button>
              </div>
            </div>
...
<?php /**PATH D:\Projects\Laravel\KL_tracker\resources\views/dashboard/outdoor.blade.php ENDPATH**/ ?>
...
<div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mt-8 mb-6">
    ...
    <div class="flex flex-wrap gap-3">
        <a href="javascript:;" data-toggle="modal" data-target="#usersAddModal" id="usersAddModalButton" class="elegant-btn-primary">
    ...
    <div class="mb-6 pb-6 border-b hairline">
        <form class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                ...
                <input type="text" class="elegant-input w-full" placeholder="Name, username, email..." id="filterSearch">
            </div>
            <div>
        ...
        <form>
            <div class="p-6 space-y-5">
                <div>
                    ...
                    <input type="text" class="elegant-input w-full" placeholder="Name" id="usersEditName" required>
                </div>
                <div>
                    <label class="small-caps text-gray-600 mb-2 block">Username</label>
                    <input type="text" class="elegant-input w-full" placeholder="System Login Username" id="usersEditUsername" required>
                </div>
                <div>
                    <label class="small-caps text-gray-600 mb-2 block">Role</label>
                ...
                <div>
                    ...
                    <input type="email" class="elegant-input w-full" placeholder="example@gmail.com" id="usersEditEmail" required>
                </div>
            </div>
    ...
    <div class="modal__content" style="max-width: 500px;">
        ...
        <form>
            <div class="p-6 space-y-5">
                <div>
                    <label class="small-caps text-gray-600 mb-2 block">Name</label>
                    <input type="text" class="elegant-input w-full" placeholder="Name" id="usersAddName" required>
                </div>
                <div>
                    <label class="small-caps text-gray-600 mb-2 block">Username</label>
                    <input type="text" class="elegant-input w-full" placeholder="Username" id="usersAddUsername" required>
                </div>
                <div>
                    <label class="small-caps text-gray-600 mb-2 block">Role</label>
                ...
                <div>
                    ...
                    <input type="password" class="elegant-input w-full" placeholder="Password" id="usersAddPassword" required>
                </div>
                <div>
                    <label class="small-caps text-gray-600 mb-2 block">Password Confirmation</label>
                    <input type="password" class="elegant-input w-full" placeholder="Confirm Password" id="usersAddPasswordConfirmation" required>
                </div>
                <div>
                    <label class="small-caps text-gray-600 mb-2 block">Email</label>
                    <input type="email" class="elegant-input w-full" placeholder="example@gmail.com" id="usersAddEmail" required>
                </div>
            </div>
    ...
    <div class="modal__content" style="max-width: 440px;">
        <div class="p-6 text-center">
            <div class="w-16 h-16 rounded-full bg-red-50 mx-auto flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="text-red-600">
                    <circle cx="12" cy="12" r="10"></circle>
            ...
            <p class="text-gray-600">This action cannot be undone. The user will be permanently removed from the system.</p>
        </div>
    ...
    closeAltEditorModal('#' + target.attr('id'));
        ...
        function initUsersDatatable() {
            ...
            if (existingDiv) {
                ...
                existingDiv.innerHTML = existingDiv.innerHTML.replace('Show ', '<span class="text-sm text-gray-600">Show</span> ');
                existingDiv.innerHTML = existingDiv.innerHTML.replace(' entries', '<span class="text-sm text-gray-600">entries</span>');
        ...
        window.showSubmitToast = function (msg) { console.log('[toast]', msg); };
        }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Gjlang\kl_guide_tracker\resources\views\users\index.blade.php ENDPATH**/ ?>
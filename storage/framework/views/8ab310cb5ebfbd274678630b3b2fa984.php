            ...
            <div class="sm:flex items-center sm:mr-4">
                ...
                <select class="input w-full sm:w-32 xxl:w-full mt-2 sm:mt-0 sm:w-auto border select2-location" id="filterBillboardBookingLocation">
                    ...
                    <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($location->id); ?>" data-site="<?php echo e($location->site_number); ?>"><?php echo e($location->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
        </form>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function loadMonthlyJobs() {
            $.ajax({
                url: '<?php echo e(route("billboard.monthly.ongoing")); ?>',
                method: 'GET',
                data: {
        ...
        $(document).on('change', '.status-dropdown', function () {
            ...
            $.ajax({
                url: '<?php echo e(route("jobs.update.monthly.status")); ?>',
                method: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
                    id: id,
        ...
        function billboardBookingDeleteButton() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('billboard.booking.delete')); ?>",
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    id: id,
                },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Gjlang\kl_guide_tracker\resources\views\billboard\booking\index.blade.php ENDPATH**/ ?>
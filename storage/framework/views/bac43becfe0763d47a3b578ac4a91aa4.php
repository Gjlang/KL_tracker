...
<body>
    ...
    <!-- ✅ Logo -->
    <img src="<?php echo e(public_path('images/bluedalemedia.jpg')); ?>" class="logo" alt="Company Logo">
        ...
        <div class="section">
            <div class="info-container">
                ...
                <div class="info-column">
                    <table class="info-table">
                        <tr><td>Site Number:</td><td><?php echo e($billboard->site_number); ?></td></tr>
                        <tr><td>Type:</td><td><?php echo e($billboard->type); ?></td></tr>
                        <tr><td>Size:</td><td><?php echo e($billboard->size); ?></td></tr>
                        <tr><td>Lighting:</td><td><?php echo e($billboard->lighting); ?></td></tr>
                        <tr><td>Traffic Volume:</td><td><?php echo e($billboard->traffic_volume); ?></td></tr>
                    </table>
                </div>
                ...
                <div class="info-column">
                    <table class="info-table">
                        <tr><td>Location:</td><td><?php echo e($billboard->location->name ?? '-'); ?></td></tr>
                        <tr><td>District:</td><td><?php echo e($billboard->location->district->name ?? '-'); ?></td></tr>
                        <tr><td>State:</td><td><?php echo e($billboard->location->district->state->name ?? '-'); ?></td></tr>
                        <tr><td>Council:</td><td><?php echo e($billboard->location->council->abbreviation); ?> - <?php echo e($billboard->location->council->name ?? '-'); ?></td></tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo e($mapUrl); ?>" target="_blank" rel="noopener noreferrer">
                                    <?php echo e($billboard->gps_latitude); ?>, <?php echo e($billboard->gps_longitude); ?>
            ...
            <div class="image-section">
                <div class="image-grid">
                    <?php $__currentLoopData = $billboard->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <img src="<?php echo e($img); ?>" alt="Billboard Image">
            ...
            <div class="sitetype-box">
                <p><strong><?php echo e(strtoupper($billboard->site_type ?? '-')); ?></strong></p>
            </div>
...
</html><?php /**PATH C:\Users\Gjlang\kl_guide_tracker\resources\views\billboard\exportlist.blade.php ENDPATH**/ ?>
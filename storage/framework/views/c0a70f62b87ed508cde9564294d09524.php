        ...
        <div>
            ...
            <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                ...
                <div class="text-center">
                    <a href="javascript:;" 
                    onclick="openAltEditorModal('#clientCompanyAddModal')" 
            ...
            <div class="overflow-x-auto">
                <table id="client_company_table" class="min-w-full border-collapse border border-neutral-300"> <!-- Add border classes to the table -->
                    ...
                    <tbody id="client_company_tbody" class="bg-white divide-y divide-neutral-200"> <!-- 'divide-y' adds borders between rows -->
...
<div class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden" id="clientCompanyAddModal">
    <div class="modal__content bg-white rounded-lg shadow-xl w-full max-w-md sm:max-w-lg mx-4">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
            ...
            <button type="button" onclick="closeAltEditorModal('#clientCompanyAddModal')" class="text-gray-500 hover:text-gray-700">
        ...
        <form id="clientCompanyAddForm">
            <div class="p-6 space-y-4">
                ...
                <div id="picContainer">
                    <div class="pic space-y-4">
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out" placeholder="Enter Name" name="pic_names[]" required>
                        </div>
                        <div class="space-y-1">
                            <label class="block text-sm font-medium text-gray-700">Email</label>
                            <input type="email" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out" placeholder="Enter Email" name="pic_emails[]">
                        </div>
                        <div class="space-y-1">
                            <label class="block text-sm font-medium text-gray-700">Phone No.</label>
                            <input type="tel" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out" placeholder="Enter Phone No." name="pic_phones[]">
                        </div>
                        <div class="space-y-1">
                            <label class="block text-sm font-medium text-gray-700">Designation</label>
                            <input type="text" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out" placeholder="Enter Designation" name="pic_designations[]">
                        </div>
                        <!-- Remove Button for first PIC (initially disabled) -->
                        <div class="flex justify-end">
                            <button type="button" class="text-sm text-red-600 hover:text-red-800 px-2 py-1 rounded-md border border-red-300 hover:bg-red-50 disabled:opacity-50 disabled:cursor-not-allowed" onclick="removePIC(this)" disabled>
                                Remove
                            </button>
                        </div>
                    </div>
                ...
                <!-- Add PIC Button -->
                <div class="pt-2">
                    <button type="button" onclick="picAdd()" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition">
                        + Add Another PIC
                    </button>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end px-6 py-4 space-x-3 border-t border-gray-200 bg-gray-50 rounded-b-lg">
                <button type="button" onclick="closeAltEditorModal('#clientCompanyAddModal')" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition">
                    Cancel
                </button>
                <!-- Changed button type to "submit" and removed onclick -->
                <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition" id="addClientCompany">
                    Submit
                </button>
            </div>
        </form>
...
<template id="picTemplate">
    <div class="pic space-y-4">
        ...
        <div class="flex justify-end">
            <button type="button" class="text-sm text-red-600 hover:text-red-800 px-2 py-1 rounded-md border border-red-300 hover:bg-red-50" onclick="removePIC(this)">
                Remove
            </button>
        </div>
    </div>
...
<div class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden" id="clientCompanyEditModal">
    <!-- Backdrop -->
    <div class="modal__content bg-white rounded-lg shadow-xl w-full max-w-md sm:max-w-lg mx-4"> <!-- Adjusted max-width and added mx-4 -->
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Edit Client Company</h2> <!-- Updated title -->
            <!-- Close Button -->
            <button type="button" onclick="closeAltEditorModal('#clientCompanyEditModal')" data-dismiss="modal" class="text-gray-500 hover:text-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                </svg>
            </button>
            ...
            <div class="p-6 space-y-4"> <!-- Used space-y for consistent vertical spacing -->
                ...
                <div class="space-y-1">
                    ...
                    <input
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"
                        placeholder="Enter Phone Number"
                        id="clientCompanyEditPhone"
                        name="phone">
                </div>
            </div>
            <!-- Modal Footer -->
            <div class="flex items-center justify-end px-6 py-4 space-x-3 border-t border-gray-200 bg-gray-50 rounded-b-lg">
                <button type="button" onclick="closeAltEditorModal('#clientCompanyEditModal')" data-dismiss="modal" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition">
                    Cancel
                </button>
                <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition" id="clientCompanyEditButton">
...
<div class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden" id="clientCompanyDeleteModal">
    <div class="modal__content bg-white rounded-lg shadow-xl w-full max-w-md sm:max-w-sm mx-4">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
            ...
            <button type="button" onclick="closeAltEditorModal('#clientCompanyDeleteModal')" data-dismiss="modal" class="text-gray-500 hover:text-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                </svg>
            </button>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center px-6 py-4 space-y-3 sm:space-y-0 sm:space-x-3 border-t border-gray-200 bg-gray-50 rounded-b-lg">
            <button type="button" onclick="closeAltEditorModal('#clientCompanyDeleteModal')" data-dismiss="modal" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition">
                Cancel
            </button>
            <button type="button" class="px-4 py-2 text-sm font-medium text-white bg-red-600 border border-transparent rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition" id="clientCompanyDeleteButton">
                Delete
            </button>
        </div>
    </div>
...
<div class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden" id="picAddModal">
    <div class="modal__content bg-white rounded-lg shadow-xl w-full max-w-md sm:max-w-lg mx-4">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
            ...
            <button type="button" onclick="closeAltEditorModal('#picAddModal')" data-dismiss="modal" class="text-gray-500 hover:text-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                </svg>
            </button>
        ...
        <form id="picAddForm"> <!-- Added ID for potential event listener -->
            ...
            <div class="p-6 space-y-4"> <!-- Used space-y for consistent vertical spacing -->
                ...
                <div class="space-y-1">
                    ...
                    <input
                        type="text"
                        title="Please enter client designation"
                        placeholder="Enter Designation"
                        class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"
                        id="picAddDesignation"
                        name="designation">
                </div>
                <!-- PIC Name -->
                <div class="space-y-1">
                ...
                <div class="space-y-1">
                    ...
                    <input
                        type="tel"
                        title="Please enter contact number in correct format"
            ...
            <!-- Modal Footer -->
            <div class="flex items-center justify-end px-6 py-4 space-x-3 border-t border-gray-200 bg-gray-50 rounded-b-lg">
                <button type="button" onclick="closeAltEditorModal('#picAddModal')" data-dismiss="modal" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition">
                    Cancel
                </button>
                <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition" id="picAddButton">
                    Save PIC
                </button>
            </div>
        </form>
...
<div class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden" id="picEditModal">
    <div class="modal__content bg-white rounded-lg shadow-xl w-full max-w-md sm:max-w-lg mx-4">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Edit Person In Charge (PIC)</h2>
            <button type="button" onclick="closeAltEditorModal('#picEditModal')" data-dismiss="modal" class="text-gray-500 hover:text-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                </svg>
            </button>
        ...
        <form id="picEditForm"> <!-- Added ID for potential event listener -->
            ...
            <!-- Modal Footer -->
            <div class="flex items-center justify-end px-6 py-4 space-x-3 border-t border-gray-200 bg-gray-50 rounded-b-lg">
                <button type="button" onclick="closeAltEditorModal('#picEditModal')" data-dismiss="modal" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition">
                    Cancel
                </button>
                <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition" id="picEditButton">
                    Update
                </button>
            </div>
        </form>
...
<div class="modal fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden" id="picDeleteModal">
    <div class="modal__content bg-white rounded-lg shadow-xl w-full max-w-md sm:max-w-sm mx-4">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Confirm Deletion</h2>
            <button type="button" onclick="closeAltEditorModal('#picDeleteModal')" data-dismiss="modal" class="text-gray-500 hover:text-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                </svg>
            </button>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center px-6 py-4 space-y-3 sm:space-y-0 sm:space-x-3 border-t border-gray-200 bg-gray-50 rounded-b-lg">
            <button type="button" onclick="closeAltEditorModal('#picDeleteModal')" data-dismiss="modal" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition">
                Cancel
            </button>
            <button type="button" class="px-4 py-2 text-sm font-medium text-white bg-red-600 border border-transparent rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition" id="picDeleteButton">
                Delete
            </button>
        </div>
    </div>
    ...
    $(document).ready(function() {
        ...
        function initClientCompanyDatatable() {
            ...
            const table = $('#client_company_table').DataTable({
                ...
                columns: [
                    {
                        ...
                        data: null,
                        defaultContent: '',
                        render: () => '<button class="bg-blue-600 text-white px-1 rounded">+</button>'
                    },
                    {
                        data: null,
                        name: 'no',
                ...
                createdRow: function(row, data) {
                    ...
                    clientCell.removeClass('text-center').addClass('text-left'); // Remove center, add left
                    ...
                    clientAddrCell.removeClass('text-center').addClass('text-left'); // Ensure center
        ...
        $('#clientCompanyAddForm').off('submit').on('submit', function(e) {
            ...
            $('#picContainer .pic').each(function () {
                ...
                const designationInput = picDiv.querySelector('input[name="pic_designations[]"]');
            ...
            $.ajax({
                ...
                success: function(response) {
                    try {
                        ...
                        const initialPic = document.getElementById('picContainer').firstElementChild;
                        ...
                        const initialRemoveButton = initialPic.querySelector('button[onclick="removePIC(this)"]');
                        ...
                        alert('Update successful, but there was an issue refreshing the table.');
                    }
                },
                error: function(xhr) {
                    try {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Gjlang\kl_guide_tracker\resources\views/client_company/index.blade.php ENDPATH**/ ?>
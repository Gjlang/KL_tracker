            ...
            <div class="sm:flex items-center sm:mr-4">
                ...
                <select class="input w-full sm:w-32 xxl:w-full mt-2 sm:mt-0 sm:w-auto border" id="filterAvailabilityType">
                    ...
                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($type->prefix); ?>"><?php echo e($type->type); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="row sm:flex items-center sm:mr-4">
...
<script>
    ...
    $('#filterAvailabilityDistrict').on('change', function () {
        ...
        if (districtId !== '') {
            $.ajax({
                url: '<?php echo e(route("location.getLocations")); ?>',
                type: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
    ...
    function loadMonthlyAvailability() {
        ...
        $.ajax({
            url: '<?php echo e(route("billboard.monthly.availability")); ?>',
            method: 'GET',
            data: {
    ...
    function initBillboardAvailabilityDatatable() {
        ...
        const table = $('#billboard_availability_table').DataTable({
            ...
            iDisplayLength: 25,
            ajax: {
                url: "<?php echo e(route('billboard.booking.list')); ?>",
                type: "POST",
                data: function(d) {
    ...
    $(document).ready(function() {
        ...
        function inputBookingSubmit() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('billboard.booking.create')); ?>",
                data: {
                ...
                success: function(response) {
                    ...
                    window.location.href = "<?php echo e(route('billboard.booking.index')); ?>";
        ...
        $("#editStatusModal form").on("submit", function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('billboard.update.status')); ?>",
                type: "POST",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    id: bookingId,
        ...
        function editBooking() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('billboard.booking.edit')); ?>",
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    status: status,
                    remarks: remarks,
        ...
        $('#saveAvailabilityButton').on('click', function (e) {
            ...
            $.ajax({
                url: '<?php echo e(route("billboard.availability.update")); ?>',
                method: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
                    id: id,
        ...
        function editServiceRequest() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('serviceRequest.edit')); ?>",
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    desc: description,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Projects\Laravel\KL_tracker\resources\views\billboard\availability\index.blade.php ENDPATH**/ ?>
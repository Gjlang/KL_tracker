...
function closeAltEditorModal(selector) {
  ...
  window.closeModal(id);
        ...
        function inventoryAddButton() {
            ...
            $.ajax({
    type: 'POST',
    url: "<?php echo e(route('stockInventory.create')); ?>", // ✅ your POST route
    headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Gjlang\kl_guide_tracker\resources\views/stockInventory/index.blade.php ENDPATH**/ ?>